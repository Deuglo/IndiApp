...
/**
   ...
   1% fee is sent to the charity wallet
  
  
    Submitted by IndiApp (Deuglo Infosystem Private Limited)
...
contract IndiApp is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address charityWalletAddress = 0x70D0433b62F0A7a3e2E40aa6b19b41AcD2519B73;
    ...
    string private _name = "IndiApp";
    string private _symbol = "INDIAPP";
